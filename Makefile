...
.PHONY: install install-api install-web dev dev-api dev-web docker-up docker-down db-migrate backup-db ingest-huntsville ingest-huntsville-agendas ingest-madison-county migrate-phase3-postgres docker-migrate-phase3-postgres phase3-store-status send-alerts lint typecheck test test-api test-web test-performance e2e build clean
