...
Final PR review and CI remain pending C03/S02 dependency integration. The passed run proves the exact `f2e70a4` head, not an untested future rebase or deployment readiness.
