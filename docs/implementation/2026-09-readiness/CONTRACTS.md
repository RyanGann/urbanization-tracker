...
Candidate identity is distinct from candidate revision; logical agenda document identity is distinct from downloaded blob hash. Unchanged candidate content preserves decisions. Changed content creates a pending revision while retaining prior decisions and published versions. Publication requires supported geometry; staging permits an explicitly unknown location.
